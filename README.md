...
* **WPILib 2026**: Use
  the [WPILib installer](https://docs.wpilib.org/en/stable/docs/zero-to-robot/step-2/wpilib-setup.html) for the current
  season.
...
* **FRC Driver Station**: If you want to drive, you'll need
  the [FRC Driver Station](https://docs.wpilib.org/en/stable/docs/software/driverstation/driver-station.html).
